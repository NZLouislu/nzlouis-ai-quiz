...
const models = [
  {
    ...
    name: "GPT-OSS 20B",
    desc: "Open-source 20B model, great for broad and general quiz generation.",
    latency: "150ms",
    free: true,
  },
  {
    ...
    desc: "Strong reasoning and creative generation, ideal for high-quality quizzes.",
    latency: "160ms",
    free: true,
  },
  {
    ...
    name: "DeepSeek R1",
    desc: "Excels at complex reasoning and challenging quiz design.",
    latency: "120ms",
    free: true,
  },
  {
    ...
    name: "LLaMA 3.1",
    desc: "Versatile and powerful, suitable for quizzes across multiple domains.",
    latency: "140ms",
    free: true,
  },
  {
    ...
    name: "Qwen3",
    desc: "Expert in coding and technical quizzes, perfect for programming tests.",
    latency: "135ms",
    free: true,
  },
  {
    ...
    name: "MAI-DS-R1",
    desc: "Microsoft-optimized model, stable and efficient for large-scale quiz generation.",
    latency: "125ms",
    free: true,
  },
  {
    ...
    desc: "Mixture-of-experts model, strong at diverse and personalized quiz creation.",
    latency: "140ms",
    free: true,
  },
  {
    ...
    desc: "Excellent structured output, ideal for standardized and layered quizzes.",
    latency: "130ms",
    free: true,
  },
];
